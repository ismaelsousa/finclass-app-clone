...
import emptyResultsIcon from '../../../assets/icons/empty/empty-results.png';
 ...
 import {CenterText, CloseIcon, Container, ContainerEmpty, ContainerHeader, EmptyIcon, SearchIcon} from './styles'
...
const  Search = () => {
  ...
  return (
    <Container>
      <Separator height={20}/>
      <ContainerHeader>
        <Text type='bold' size={22}>Buscar</Text>
        {!!searchText && <Text onPress={handleCleanText} type='bold' size={12}>Cancelar</Text>}
      </ContainerHeader>
      <Separator height={12} />
      <Input 
      ...
      {hasFocus && (
        <>
          <Separator height={20} />
          <Text type='bold' size={22}>Últimas buscas</Text>
          <Separator height={20} />
      ...
      {!!searchText && !hasFocus && (
        <ContainerEmpty>
          ...
          <Separator height={60} />
          <CenterText size={22} type='bold'>{`Nenhum resultado \ndisponível`}</CenterText>
          <Separator height={60} />
          <Dots amount={6}/>
        </ContainerEmpty>
      )}

...
import { Container, Content, Error, EyeIcon, Label, ToggleEye, TextInput, LeftIconContainer, RightIconContainer } from './styles';
    ...
    <Container>
      ...
      <Content>
        ...
        <TextInput
          ...
          {...rest}
        />
        {!!rightIcon && !secureTextEntry && <RightIconContainer>{rightIcon}</RightIconContainer>}
        {secureTextEntry && (
